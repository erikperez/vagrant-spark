...
echo 'Installing spark-1.6.0 pre-built for hadoop 2.6'
wget http://www.eu.apache.org/dist/spark/spark-1.6.0/spark-1.6.0-bin-hadoop2.6.tgz
tar xvf spark-1.6.0-bin-hadoop2.6.tgz -C /usr/local/
echo 'export SPARK_HOME=/usr/local/spark-1.6.0-bin-hadoop2.6' >> .bashrc
. .bashrc
